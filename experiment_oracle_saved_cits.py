...
def main():
    ...
    csv_path = output_dir / "experiment_oracle_saved_cits_summary.csv"
    raw_path = output_dir / "experiment_oracle_saved_cits_raw.csv"
    ...
    df_raw.to_csv(output_dir / "experiment_4_raw.csv", index=False)
    ...
    df_summary.to_csv(output_dir / "experiment_4_summary.csv", index=False)
